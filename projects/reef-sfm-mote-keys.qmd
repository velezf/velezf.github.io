...
![Camera-nadir DSM (left, along-axis tilt ≈ +4.38°) versus Zero-pitch DSM (right, ≈ +0.17°), with along-axis mean-elevation profiles overlaid. The leveling decision the published methods text never names is visible in the profile overlay.](figures/fig1_orientation_convention.png){#fig-orientation fig-align="center"}
...
![Reconciliation of three structural-complexity metrics against published values. Published values enter only through the pre-firewalled reconciliation report — the P13HMEON CSV is never opened by the figure layer.](figures/fig2_reconciliation.png){#fig-reconciliation fig-align="center"}
